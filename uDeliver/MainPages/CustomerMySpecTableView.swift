...
class CustomerMySpecTableView: UIViewController {
    ...
    var Specialty_into = ["Курьер, такси, трезвый водитель, грузчик, перевозка, переезд и т.д.",
    ...
    "Специалисты по ремонту бытовой техники, электронных и видео приборов и т.д.",
    ...
    @IBAction func button1Tapped(_ sender: UIButton) {
        UIView.animate(withDuration: 0.1, animations: {
            sender.backgroundColor = UIColor(red: 0.9843, green: 0.2431, blue: 0.2471, alpha: 0.1)
        })
        UIView.animate(withDuration: 0.1, animations: {
